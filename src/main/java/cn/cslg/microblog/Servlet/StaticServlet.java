package cn.cslg.microblog.Servlet;
...
import cn.cslg.microblog.Util.Special.Servlets;
...
//		String contentPath = request.getContextPath();
		...
		String[] tempContent = contentPath.split("/");
		contentPath = contentPath.substring(tempContent[1].length()+1, contentPath.length());
