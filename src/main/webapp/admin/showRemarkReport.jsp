			...
			<div class="box col-md-12">
				<div class="box-inner">
					<div class="box-content">
						<div class="alert alert-info">评论举报未处理记录</div>
						<table
							...
							<tbody>
								<c:forEach var="report" items="${reports}" varStatus="index">
									<tr>
										...
										<td class="center">
											<a class="btn btn-info" onclick="showRemark(${report.id})">查看</a>
											<a class="btn btn-success" href="${ctx }/report_remarkPass.action?id=${report.id}">通过</a> 
											<a class="btn btn-danger" href="${ctx }/report_remarkUnpass.action?id=${report.id}"> 拒绝</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
